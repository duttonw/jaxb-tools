 ...
 *
 * <pre>
 *  -Xcommons-lang:addToStringMethod=TRUE
 *  -Xcommons-lang:addHashCodeMethod=TRUE
        ...
        throws BadCommandLineException
    {
        ...
        if (arg.startsWith(TOSTRING_STYLE_PARAM))
        {
            ...
            if (value.matches("^[A-Z0-9_]+$")) {
                //We may have a ToStringStyle static final variable
                try {
                    ...
                    logger.error("Could not verify : '" + TOSTRINGSTYLE_CLASSNAME + "." + value + "'. Confirm it exists or add to Plugins dependencies 'commons-lang3' which has variable", e);
